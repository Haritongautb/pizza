...
const Cart: React.FC = () => {
    ...
    const renderElements = (arr: CartItem[]) => {

        return arr.map((item: CartItem) => <CartItemBlock key={item.id} {...item}/>)
    }
    const elements = renderElements(items)
                    ...
                    <div className="cart">
                        ...
                        <div className="cart__bottom">
                            <div className="cart__bottom-details">
                                <span> Всего пицц: <b>
                                    {
                                        items.reduce((current: number, item: any) => current + item.count, 0)
                                    } шт.</b> </span>
